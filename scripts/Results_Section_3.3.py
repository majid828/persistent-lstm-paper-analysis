"""
Post-processing and figure-generation script for the CUDA LSTM vs Persistent LSTM
long-memory basin experiment.

This script was used to generate manuscript figures and summary metrics comparing
Persistent LSTM and CUDA LSTM performance across selected CAMELS basins.

Users should update the run directories, CAMELS data paths, and output directory
in the USER SETTINGS section before running the script on another system.
"""
...
PERSISTENT_DAILY_RUN_DIRS = [
    Path("/home/mhshah1/runs/persistent_4basins_seq_sweep/persistent_seed_111_0905_233615"),
    Path("/home/mhshah1/runs/persistent_4basins_seq_sweep/persistent_seed_222_0905_234018"),
    Path("/home/mhshah1/runs/persistent_4basins_seq_sweep/persistent_seed_333_0905_234628"),
    Path("/home/mhshah1/runs/persistent_4basins_seq_sweep/persistent_seed_444_0905_235256"),
    Path("/home/mhshah1/runs/persistent_4basins_seq_sweep/persistent_seed_555_0905_235843"),
]

# Only CUDA LSTM sequence length 365 is kept
CUDA_SEQ_GROUPS = {
    365: [
        Path("/home/mhshah1/runs/cudalstm_daily_compare/persistent_seed_111_1005_000541"),
        Path("/home/mhshah1/runs/cudalstm_daily_compare/persistent_seed_222_1005_000732"),
        Path("/home/mhshah1/runs/cudalstm_daily_compare/persistent_seed_333_1005_000925"),
        Path("/home/mhshah1/runs/cudalstm_daily_compare/persistent_seed_444_1005_001117"),
        Path("/home/mhshah1/runs/cudalstm_daily_compare/persistent_seed_555_1005_001307"),
    ],
}

OUTDIR = Path("/mnt/disk1/to_laptop/daily_persistent_vs_cuda365_no_warmup_paper_plotsnonstaionary2")
...
def save_basin_outputs(df_eval_compare: pd.DataFrame, basin: str, seq_lengths: list[int]):
    ...
    out_png = OUTDIR / f"{basin}_daily_hydrograph_persistent_vs_cuda365_no_warmup_{WARMUP_DAYS}d_paper.png"
    fig.savefig(out_png, dpi=DPI, bbox_inches="tight")
    plt.close(fig)

    if SAVE_CSV:
        out_csv = OUTDIR / f"{basin}_daily_compare_persistent_vs_cuda365_no_warmup_{WARMUP_DAYS}d.csv"
...
def save_scatter_plot(df_metrics: pd.DataFrame, seq_len: int):
    ...
    ax.set_title(
        "Performance Gain vs Non-Stationarity",
        fontweight="bold",
    )
    ax.grid(True, alpha=0.30)
    ...
    out_path = OUTDIR / f"tau_vs_delta_nse_cuda{seq_len}_no_warmup_{WARMUP_DAYS}d_paper.png"
...
def save_cdf_nse_plot(df_metrics: pd.DataFrame):
    ...
    out_path = OUTDIR / f"cdf_nse_persistent_vs_cuda365_no_warmup_{WARMUP_DAYS}d_paper.png"
    fig.savefig(out_path, dpi=DPI, bbox_inches="tight")
    plt.close(fig)
...
def main():
    ...
    if metrics_rows:
        ...
        summary_csv = OUTDIR / f"basin_full_obs_tau_test_metrics_persistent_vs_cuda365_no_warmup_{WARMUP_DAYS}d_summary.csv"
